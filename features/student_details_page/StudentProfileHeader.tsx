      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="space-y-1">
                  <p className="text-xs text-red-800">
                    ...
                    <span className="font-medium">
                      {student.medical?.bloodGroup || "N/A"}
                    </span>
                  </p>
                  <p className="text-xs text-red-800">
                    Genotype:{" "}
                    <span className="font-medium">
                      {student.medical?.genotype || "N/A"}
                    </span>
                  </p>
                  <p className="text-xs text-red-800">
                    Allergies:{" "}
                    <span className="font-medium">
                      {student.medical?.allergies || "None"}
                    </span>
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-2">
            <button
              className="flex items-center justify-center lg:justify-start gap-2 px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors cursor-pointer whitespace-nowrap"
